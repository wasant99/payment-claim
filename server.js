...
// ─── API: POST project (create new) ───
app.post('/api/:pid/project', (req, res) => {
  try {
    const f = dbFile(req.params.pid);
    const data = { project: { name: req.params.pid, contractor: '', workType: '', contractValue: 0, vatRate: 7, ...req.body }, periods: [] };
